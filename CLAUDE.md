...
- **hooks/memory-inject.sh** — UserPromptSubmit hook. Reads prompt from stdin, keyword-matches against cached memory descriptions, injects top matches as context.
